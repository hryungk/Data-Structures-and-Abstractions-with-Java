...
{
    private Node firstNode; // Head reference to first ndoe of chain
    ...
    public boolean isEmpty()
    {
        ...
        {
            assert (firstNode != null) && (lastNode != null): "numberOfEntries is not 0 but firstNode and lastNode are null";
            result = false;
        } // end if
        return result;
    } // end isEmpty
