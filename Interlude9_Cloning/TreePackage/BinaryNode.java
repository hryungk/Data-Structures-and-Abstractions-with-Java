...
/**
   ...
   @version 5.0
*/
class BinaryNode<T extends Copyable> implements Cloneable
{
    private T             data;
    ...
    public Object clone()
    {
        ...
        if (leftChild != null)
            theCopy.leftChild = (BinaryNode<T>) leftChild.clone();
        if (rightChild != null)
            theCopy.rightChild = (BinaryNode<T>) rightChild.clone();
